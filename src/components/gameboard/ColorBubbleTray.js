...
export default function ColorBubbleTray({
  gameState,
  allColorBubbles,
  ...
  return (
    <section id='color-bubble-tray'>
      ...
      {allColorBubbles.map((item) => {
        let imageIndex = allColorBubbles.indexOf(item);
        ...
        return (
          <div
            ...
            style={{
              backgroundColor: allColorBubbles[imageIndex],
            }}
            onMouseEnter={currentFieldMouseEnter}
            onMouseLeave={currentFieldMouseLeave}
            onClick={(event) => {
